...
// Returns the public 'AppBundle\Controller\BooksController' shared autowired service.
...
require_once $this->targetDirs[3].'/src/AppBundle/Controller/BooksController.php';

return $this->services['AppBundle\Controller\BooksController'] = new \AppBundle\Controller\BooksController();
