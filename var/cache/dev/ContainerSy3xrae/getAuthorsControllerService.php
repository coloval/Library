...
// Returns the public 'AppBundle\Controller\AuthorsController' shared autowired service.
...
require_once $this->targetDirs[3].'/src/AppBundle/Controller/AuthorsController.php';

return $this->services['AppBundle\Controller\AuthorsController'] = new \AppBundle\Controller\AuthorsController();
