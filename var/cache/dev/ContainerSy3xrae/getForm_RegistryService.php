...
return $this->services['form.registry'] = new \Symfony\Component\Form\FormRegistry(array(0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\ServiceLocator(array('AppBundle\\Form\\AuthorsType' => function () {
    return ${($_ = isset($this->services['AppBundle\Form\AuthorsType']) ? $this->services['AppBundle\Form\AuthorsType'] : $this->services['AppBundle\Form\AuthorsType'] = new \AppBundle\Form\AuthorsType()) && false ?: '_'};
}, 'AppBundle\\Form\\BooksType' => function () {
    return ${($_ = isset($this->services['AppBundle\Form\BooksType']) ? $this->services['AppBundle\Form\BooksType'] : $this->services['AppBundle\Form\BooksType'] = new \AppBundle\Form\BooksType()) && false ?: '_'};
